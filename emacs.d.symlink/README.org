...
* Credits
This =emacs.d/= was heavily based on [[https://github.com/anschwa/emacs.d][Adam Schwartz' configuration]],
which in turn was inspired by the following.
...
* Appearance
** Theme
I use the fantastic [[http://ethanschoonover.com/solarized][Solarized theme by Ethan Schoonover]].
